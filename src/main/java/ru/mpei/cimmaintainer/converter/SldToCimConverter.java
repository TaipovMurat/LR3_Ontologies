...
public class SldToCimConverter {
    ...
    public void convert(SingleLineDiagram sld, Map<String, String> devices, Map<String, String> voltages) {
        ...
        linksToRDFResurs(linksList, elementsMap);


        System.out.println();
    }

    private void linksToRDFResurs(List<Link> linksList, Map<String, Element> elementsMap){
        linksList.stream()
